  ...
  <div class="transaction-container">
    <div class="transaction-card">
      ...
      <div class="transactions-content">
        <div v-if="filteredTransactionDetailList.length === 0" class="empty-state">
...
.transaction-card-item:nth-child(1) { animation-delay: 0.05s; }
.transaction-card-item:nth-child(2) { animation-delay: 0.1s; }
.transaction-card-item:nth-child(3) { animation-delay: 0.15s; }
.transaction-card-item:nth-child(4) { animation-delay: 0.2s; }
.transaction-card-item:nth-child(5) { animation-delay: 0.25s; }
</style>
