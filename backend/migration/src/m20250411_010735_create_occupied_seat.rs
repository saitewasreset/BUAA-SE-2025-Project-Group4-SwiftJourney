        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(big_integer(OccupiedSeat::TrainId).not_null())
                    .col(big_integer(OccupiedSeat::SeatTypeId).not_null())
                    .col(date(OccupiedSeat::DepartureDate).not_null())
                    .col(big_integer(OccupiedSeat::SeatId).not_null())
                    .col(big_integer(OccupiedSeat::BeginStationId).not_null())
                    .col(big_integer(OccupiedSeat::EndStationId).not_null())
                    .col(big_integer(OccupiedSeat::PersonInfoId).not_null())
                    .index(
                        Index::create()
