...
use shared::domain::model::dish::DishId;
use shared::domain::model::hotel::{HotelDateRange, HotelId, HotelRoomTypeId};
...
use shared::domain::model::takeaway::TakeawayDishId;
use shared::domain::model::train::{SeatType, SeatTypeId, SeatTypeName};
use shared::domain::model::train_schedule::{
    Seat, SeatId, SeatLocationInfo, SeatStatus, StationRange, TrainScheduleId,
};
use shared::domain::model::transaction::{Transaction, TransactionId, TransactionStatus};
use shared::domain::model::user::UserId;
use shared::domain::{AggregateManagerImpl, DiffInfo};
use shared::domain::{DbRepositorySupport, MultiEntityDiff, RepositoryError};
use shared::domain::{DiffType, Identifiable, TypedDiff};
...
impl_db_id_from_u64!(SeatId, i64, "seat");
...
impl_db_id_from_u64!(HotelRoomTypeId, i32, "hotel room type");
impl_db_id_from_u64!(DishId, i32, "dish");
