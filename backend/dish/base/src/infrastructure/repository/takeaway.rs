...
use shared::domain::model::route::{RouteId, Stop, StopId};
use shared::domain::model::station::StationId;
use shared::domain::model::takeaway::{TakeawayDish, TakeawayDishId, TakeawayShop, TakeawayShopId};
use shared::domain::{
    AggregateManagerImpl, DbRepositorySupport, Diff, DiffInfo, DiffType, Identifiable,
    MultiEntityDiff, RepositoryError, TypedDiff,
};
...
impl TakeawayShopRepository for TakeawayShopRepositoryImpl {
    ...
    async fn load_all_raw_shop(
        ...
        crate::models::takeaway_shop::Entity::find()
            .all(&self.db)
            .await
...
pub async fn save_raw_takeaway<TSR: TakeawayShopRepository, GP: GeoPort, OSP: ObjectStoragePort>(
    data: TakeawayData,
    data_path: &Path,
